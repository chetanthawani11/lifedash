        ...
        <div style={{
          ...
          <h1 style={{
            ...
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <div
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.opacity = note.isPinned ? '1' : '0.4';
                  e.currentTarget.style.backgroundColor = 'transparent';
                }}
                title={note.isPinned ? 'Unpin note' : 'Pin note'}
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill={note.isPinned ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 17v5" />
          ...
          <div style={{
            ...
            {note.tags && note.tags.length > 0 && (
              <span>
                Tags: {note.tags.map((tag: string, i: number) => (
                  <span key={i}>
                    {i > 0 && ', '}
